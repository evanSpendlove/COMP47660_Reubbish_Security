...
INSERT INTO users (id, name, surname, dob, pps, address, phone_number, email, nationality, password, lastactivity, gender) VALUES (1, 'staff', 'staff', '1980-01-01', '1', 'N/A', '0', 'staff@hse.ie', '2', '$2a$10$PA3CZJ0/s21xyph1reHhnO309htdArBVkUsf83IpNz/3uaUHvHDzK', 3,1);
INSERT INTO users (id, name, surname, dob, pps, address, phone_number, email, nationality, password, lastactivity, gender) VALUES (2, 'vaccinator', 'vaccinator', '1990-01-01', '2', 'N/A', '00', 'vaccinator@hse.ie', '20', '$2a$10$WgASl3pXw5UKSLe94HAvi.LGj3vWwF9NVO1MOWoYZogxmYW2kR/q6', 2,2);
INSERT INTO users (id, name, surname, dob, pps, address, phone_number, email, nationality, password, lastactivity, gender) VALUES (3, 'user', 'user', '2002-01-01', '3', 'N/A', '000', 'user@hse.ie', '10', '$2a$10$YsUF7gdAsfP7JGdFM0zyJub/xE2BQQMUN938LzE5j61dw.LQszjZS', 0,3);
...
INSERT INTO appointments(date, time, available, appointment_type, complete, user_id) VALUES ('10/3/2022', '9:00', false, 1, false, 4);
INSERT INTO appointments(date, time, available, appointment_type, complete, user_id) VALUES ('10/3/2022', '9:15', false, 2, false, 1);
INSERT INTO appointments(date, time, available, appointment_type, complete, user_id) VALUES ('10/3/2022', '9:30', false, 2, false, 6);
